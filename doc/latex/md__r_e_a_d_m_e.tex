\href{https://travis-ci.com/yoann-dufresne/ConwayBromageLib}{\texttt{ }} \hypertarget{md__r_e_a_d_m_e_autotoc_md9}{}\doxysection{What is Conway\+Bromage\+Lib ?}\label{md__r_e_a_d_m_e_autotoc_md9}
The Conway\+Bromage\+Lib (C\+BL) is a C++11 library that implements the succinct data structure described in the \href{https://www.researchgate.net/publication/49765043_Succinct_Data_Structures_for_Assembling_Large_Genomes}{\texttt{ article of Thomas C. Conway and Andrew J. Bromage}}.~\newline
 C\+BL is developped for the assembling of larges genomes. It stores canonical k-\/mers and permits query operations. More specifically, it represents an edge-\/centric {\bfseries{De Bruijn Graph}} in a memory-\/efficient way by also supporting time-\/efficient operations. \hypertarget{md__r_e_a_d_m_e_autotoc_md10}{}\doxysection{Method}\label{md__r_e_a_d_m_e_autotoc_md10}
Conway\+Bromage\+Lib is based on the \href{https://github.com/simongog/sdsl-lite}{\texttt{ S\+D\+SL}} library which provides succinct data structures. More precisely, C\+BL use the class {\ttfamily sd\+\_\+vector} which implements a sparse bit vector (vector made of zeros and ones) in order to store the k-\/mers. ~\newline
 ...
 ~\newline
 A succinct data structure is a data structure objects in memory-\/space close to the information-\/theoretic lower bounds and perform efficient query operations.\hypertarget{md__r_e_a_d_m_e_autotoc_md11}{}\doxysection{What can I do with C\+B\+L ?}\label{md__r_e_a_d_m_e_autotoc_md11}
C\+BL stores genomes sequences. Once it is done, we can apply two query operations \+: ~\newline
 ...
 A successor of a k-\/mer {\ttfamily x} is any k-\/mer of the form {\ttfamily a+x\mbox{[}1\+:k-\/1\mbox{]}} or {\ttfamily x\mbox{[}2\+:k\mbox{]}+a} with {\ttfamily a} nucleotide.\hypertarget{md__r_e_a_d_m_e_autotoc_md12}{}\doxysection{Requirements}\label{md__r_e_a_d_m_e_autotoc_md12}
C\+BL requires \+:~\newline
 {\ttfamily g++} version 8.\+2.\+0 or higher.~\newline
 {\ttfamily cmake} version 3.\+12 or higher (to build unit tests).~\newline
 Mac OS and Linux (Ubuntu) are supported.\hypertarget{md__r_e_a_d_m_e_autotoc_md13}{}\doxysection{Installation}\label{md__r_e_a_d_m_e_autotoc_md13}
...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md14}{}\doxysection{How to use C\+B\+L ?}\label{md__r_e_a_d_m_e_autotoc_md14}
...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md15}{}\doxysection{Bug reporting}\label{md__r_e_a_d_m_e_autotoc_md15}
If there are bugs or mistakes in C\+BL please send us an issue on \href{https://github.com/yoann-dufresne/ConwayBromageLib/issues}{\texttt{ C\+BL issue reports}} \hypertarget{md__r_e_a_d_m_e_autotoc_md16}{}\doxysection{External ressources}\label{md__r_e_a_d_m_e_autotoc_md16}
C\+BL uses others libraries to work.~\newline
 The \href{https://github.com/simongog/sdsl-lite}{\texttt{ S\+D\+SL}} that is a library implementing succinct data structures. We use it to implement bit vector (sd\+\_\+vector in S\+D\+SL syntax).~\newline
 The \href{https://github.com/martinmoene/lest\#other-macros}{\texttt{ Lest}} library is used to write units tests. \hypertarget{md__r_e_a_d_m_e_autotoc_md17}{}\doxysection{Technical description for developers}\label{md__r_e_a_d_m_e_autotoc_md17}
\href{http://htmlpreview.github.io/?https://github.com/yoann-dufresne/ConwayBromageLib/blob/master/doc/html/index.html}{\texttt{ Documentation}} \hypertarget{md__r_e_a_d_m_e_autotoc_md18}{}\doxysubsection{The Kmer\+Manipulator class}\label{md__r_e_a_d_m_e_autotoc_md18}
Abstract class that manage encoding (A\+C\+GT or A\+C\+TG) and size (the k) for k-\/mers~\newline
 Mother class of \mbox{\hyperlink{class_kmer_manipulator_a_c_g_t}{Kmer\+Manipulator\+A\+C\+GT}} and \mbox{\hyperlink{class_kmer_manipulator_a_c_t_g}{Kmer\+Manipulator\+A\+C\+TG}} \hypertarget{md__r_e_a_d_m_e_autotoc_md19}{}\doxysubsection{Kmer\+Manipulator\+A\+C\+G\+T\+::encode and Kmer\+Manipulator\+A\+C\+T\+G\+::encode}\label{md__r_e_a_d_m_e_autotoc_md19}
...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md20}{}\doxysubsection{Kmer\+Manipulator\+A\+C\+G\+T\+::decode and Kmer\+Manipulator\+A\+C\+T\+G\+::decode}\label{md__r_e_a_d_m_e_autotoc_md20}
...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md21}{}\doxysubsection{Kmer\+Manipulator\+A\+C\+G\+T\+::get\+Canonical and Kmer\+Manipulator\+A\+C\+T\+G\+::get\+Canonical}\label{md__r_e_a_d_m_e_autotoc_md21}
...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md22}{}\doxysubsection{Conway\+Bromage\+::\+Conway\+Bromage(istream\& kmer\+Flux, Kmer\+Manipulator$\ast$ km)}\label{md__r_e_a_d_m_e_autotoc_md22}
...
{\bfseries{Note}} \+: The presence of the counts doesn\textquotesingle{}t affect building, they are automatically ignored by C\+BL.\hypertarget{md__r_e_a_d_m_e_autotoc_md23}{}\doxysubsection{bool Conway\+Bromage\+::contains(uint64\+\_\+t Kmer)}\label{md__r_e_a_d_m_e_autotoc_md23}
...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md24}{}\doxysubsection{uint8\+\_\+t Conway\+Bromage\+::successors(uint64\+\_\+t Kmer)}\label{md__r_e_a_d_m_e_autotoc_md24}
